...
export const ENVIRONMENTAL_SECTIONS: DisciplineSection[] = [
  {
    ...
    tests: [
      ...
      { name: 'Noise & Vibration', icon: createIcon(Waves), status: 'not-available', accessFor: ['AMT', 'Design Lead'] },
      { name: 'Soil Quality', icon: createIcon(Mountain), status: 'not-available', accessFor: ['AMT', 'Design Lead'] }
    ]
  },
  {
    id: 'ecological',
    ...
    tests: [
      { name: 'Flora Survey', icon: createIcon(TreePine), status: 'not-available', accessFor: ['AMT', 'Design Lead'] },
      { name: 'Fauna Survey', icon: createIcon(Bird), status: 'not-available', accessFor: ['AMT', 'Design Lead'] },
      { name: 'Vegetation Monitoring', icon: createIcon(Sprout), status: 'not-available', accessFor: ['AMT', 'Design Lead'] }
    ]
  },
  {
    id: 'laboratory',
    ...
    accessFor: ['Admin', 'Design Lead'] as AccessRight[],
    tests: [
      { name: 'Water Analysis', icon: createIcon(TestTubes), status: 'not-available', accessFor: ['AMT', 'Design Lead'] },
      { name: 'Soil Analysis', icon: createIcon(Microscope), status: 'not-available', accessFor: ['AMT', 'Design Lead'] },
      { name: 'Air Sample Analysis', icon: createIcon(Beaker), status: 'not-available', accessFor: ['AMT', 'Design Lead'] }
    ]
  }
];