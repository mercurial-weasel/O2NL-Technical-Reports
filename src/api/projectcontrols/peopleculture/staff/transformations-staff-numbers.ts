...
export interface ActiveStaff {
  ...
  staffTitles: string[]; // Titles only
}

// Category staff interfaces
...
/**
 * Calculate staff numbers across different categories
 */
export function calculateStaffNumbers(data: StaffData): StaffSummary {
  ...
  console.log('Generated months array', { months });
