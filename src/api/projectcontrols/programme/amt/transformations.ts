import { AMTMonthlyRecord, AMTRecords, Risk, Status } from './types';
...
export function calculateOverallStatus(record: AMTMonthlyRecord): Status {
...
export function calculateMonthlyChanges(currentMonth: AMTMonthlyRecord, previousMonth: AMTMonthlyRecord) {
  return {
...
export function calculateHistoricalTrends(records: AMTRecords) {
...
export function filterAndAggregate(records: AMTRecords, filters: {
  startDate?: string;
  endDate?: string;
  status?: Status[];
  metrics?: string[];
